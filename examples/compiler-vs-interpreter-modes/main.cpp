...
int main(int argc, char** argv) {
    ...
    /* ### COMPILER MODE ### */
    {
        ...
        /* however we have to instanciate and build a new sxeval::SXEval<int>
        object to evaluate anothe expression such as expression2... */
    }
    ...
    /* ### INTERPRETER MODE ### */
    {
        sxeval::SXEval<int> eval;
        {
            ...
            x = 5;
            y = 10;
            int result = eval.interpret(expression1, resolveVariable);
            std::cout << "Result: " << result << " for expression '"
                << expression1 << "' with x=" << x << " and y=" << y
                << std::endl;
        }
        {
            /* second evaluation */
            x = 3;
            y = 2;
            int result = eval.interpret(expression2, resolveVariable);
            std::cout << "Result: " << result << " for expression '"
                << expression2 << "' with x=" << x << " and y=" << y
                << std::endl;
        }
